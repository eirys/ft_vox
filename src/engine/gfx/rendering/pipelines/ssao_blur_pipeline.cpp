...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ssao_blur_pipeline.cpp                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: etran <etran@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/16 22:45:24 by etran             #+#    #+#             */
/*   Updated: 2024/06/19 12:57:22 by etran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void SSAOBlurPipeline::init(
    ...
    const VkShaderModule fragmentModule = _createShaderModule(device, "obj/shaders/blur.fragment.spv");
...
void SSAOBlurPipeline::destroy(const Device& device) {
